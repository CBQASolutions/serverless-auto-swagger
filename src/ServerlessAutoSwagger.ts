  ...
  generateSwagger = async () => {
    ...
    if (this.serverless.service.provider.runtime?.includes('python')) {
      const swaggerStr = JSON.stringify(this.swagger, null, 2)
        ...
        .replace(/null/g, 'None');
      let swaggerPythonString = `# this file was generated by cbqa-serverless-auto-swagger`;
      swaggerPythonString += `\ndocs = ${swaggerStr}`;
      ...
      const swaggerJavaScriptString = `// this file was generated by cbqa-serverless-auto-swagger
